...
#define DEVICE   0x53 // ADXL345 I2C device address Theoretically 
...
private:
	...
	void RobotInit()
	{
		i2cChannel2 = new I2C(I2C::kOnboard, I2C_SLAVE_ADR); // ;kadfslkmads;lkmdsa;lkmf;oewianm;oimeai;
...
//		yawGyro = new ADXRS450_Gyro(SPI::Port);
//		ADXRS450_Gyro();
